...
> **Local note:** this vendored copy adds a `[RosePineGraphite]` scheme to
> `color.ini` (graphite background ramp, foam accent) -- that is the applied
> scheme. Upstream screenshot blocks are stripped; `screenshots/` was never
> vendored.
